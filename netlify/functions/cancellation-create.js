...
// review and sign it. The signed copy (client + staff) only goes out once
// they actually sign — see cancellation-sign.js. If a copy needs to go to a
// prior agent/carrier, staff forward the signed PDF themselves afterward.
...
export default async (req) => {
  ...
  try {
    ...
    await sendEmail({
      from: FROM_ADDRESS,
      to: data.clientEmail,
      subject: 'Please review and sign your cancellation record — The East Agency',
      html,
    });
